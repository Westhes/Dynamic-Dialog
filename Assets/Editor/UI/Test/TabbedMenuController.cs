namespace GameName.UI
{
    ...
    /// <summary>
    /// TabbedMenuController is for creating tabbed pages.
    /// Important to note is that Tabs should be parented in an element called tab, and that the tabs should be named "<...>Tab". (of type label)
    /// Likewise, there should be a parent element called Content, with children called "<...>Content", matching the tabname.
    /// </summary>
