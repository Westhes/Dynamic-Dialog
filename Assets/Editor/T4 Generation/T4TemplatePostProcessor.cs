// Source: https://github.com/njannink/T4ForUnity
// Made 2 modifications to the file as described here: https://github.com/njannink/T4ForUnity/issues/1
// Modified Line 39 to "TextTemplatingFilePreprocessor", and line 59 to "Assembly-CSharp*.csproj".
...
namespace Assets.Editor
{
    ...
    public sealed class T4TemplatePostProcessor : AssetPostprocessor
    {
        ...
        public static void OnGeneratedCSProjectFiles()
        {
            ...
            try
            {
                projectFiles = Directory.GetFiles(Directory.GetCurrentDirectory(), @"Assembly-CSharp*.csproj", SearchOption.TopDirectoryOnly);
            }
